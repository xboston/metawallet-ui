 ...
 */
PullToRefresh.prototype.initSpinnerElement = function () {
...
PullToRefresh.prototype.onScroll = function () {
 ...
 */
PullToRefresh.prototype.showAnim = function () {
    this.spinnerElement.classList.add("pulltorefresh-waiting");
    this.spinnerRotating = true;
    this.spinnerElement.show();
};
 ...
 */
PullToRefresh.prototype.hideAnim = function () {
    this.spinnerElement.classList.remove("pulltorefresh-waiting");
    this.spinnerRotating = false;
    this.spinnerElement.hide();
};

PullToRefresh.prototype.remove = function () {
 ...
 */
PullToRefresh.prototype.fixBounce = function () {
    if (this._blankElement) {
        this._blankElement.parentNode.removeChild(this._blankElement);
    }
...
PullToRefresh.prototype.resetScroll = function () {
    this.element.scrollTo(0, 0);
};

PullToRefresh.prototype.clearBottomCallback = function () {
    this.bottomCallback = function () {};
};

PullToRefresh.prototype.clearTopCallback = function () {
